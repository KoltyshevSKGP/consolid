...
$requestConnected["intronumber"]="";
if($requestConnected["id"]<10) $requestConnected["intronumber"]="000000".$requestConnected["id"];
if($requestConnected["id"]>=10 && $requestConnected["id"]<100) $requestConnected["intronumber"]="00000".$requestConnected["id"];
if($requestConnected["id"]>=100 && $requestConnected["id"]<1000) $requestConnected["intronumber"]="0000".$requestConnected["id"];
if($requestConnected["id"]>=1000 && $requestConnected["id"]<10000) $requestConnected["intronumber"]="000".$requestConnected["id"];
if($requestConnected["id"]>=10000 && $requestConnected["id"]<100000) $requestConnected["intronumber"]="00".$requestConnected["id"];
?>
...
<table style="width:100%; height:0px; " cellspacing="0">
    <colgroup><col width="18">
        ...
        <td><span></span></td>
        <td><span></span></td>
        <td colspan="8"><span style="white-space:nowrap;max-width:0px;">Додаток&nbsp;7</span></td>
        <td></td>
    </tr>
    <tr class="R0">
        <td><span></span></td>
        ...
        <td><span></span></td>
        <td><span></span></td>
        <td colspan="8"><span style="white-space:nowrap;max-width:0px;">до&nbsp;Правил&nbsp;перевезень&nbsp;вантажів&nbsp;автомобільним</span></td>
        <td></td>
    </tr>
    <tr class="R0">
        <td><span></span></td>
        ...
        <td><span></span></td>
        <td><span></span></td>
        <td colspan="8"><span style="white-space:nowrap;max-width:0px;">транспортом&nbsp;в&nbsp;Україні</span></td>
        <td></td>
    </tr>
    <tr class="R0">
        ...
        <td><div style="position:relative; height:15px;width: 100%; overflow:hidden;"><span></span></div></td>
        <td><div style="position:relative; height:15px;width: 100%; overflow:hidden;"><span></span></div></td>
        <td colspan="8"><span style="white-space:nowrap;max-width:0px;">Форма&nbsp;N&nbsp;1-ТН</span></td>
        <td><div style="width:100%;height:15px;overflow:hidden;"></div></td>
    </tr>
    <tr class="R4">
        <td><span></span></td>
        <td class="R4C1" colspan="22"><span style="white-space:nowrap;max-width:0px;">ТОВАРНО-ТРАНСПОРТНА&nbsp;НАКЛАДНА</span></td>
        <td><span></span></td>
        <td><span></span></td>
        <td></td>
    </tr>
    ...
    <tr class="R7">
        <td><span></span></td>
        <td class="R7C1"><span style="white-space:nowrap;max-width:0px;">Автомобіль</span></td>
        <td class="R7C2" colspan="7">DAF,TE 96NCE,спец.вант.-сідл.тягач-Е,ВС0000СР</td>
        <td class="R7C9" colspan="4">Причіп/напівпричіп</td>
        <td class="R7C13" colspan="5">TRAILOR  TX 34CW ,заг.Н/ПРборт-тентов.Е,ВС0000ХХ</td>
        <td class="R7C18" colspan="3"><span style="white-space:nowrap;max-width:0px;">Вид&nbsp;перевезень</span></td>
        <td class="R7C13" colspan="2">Централізовані перевезення</td>
        <td><span></span></td>
        <td><span></span></td>
        <td></td>
    </tr>
    <tr class="R0">
        <td><span></span></td>
        <td><span></span></td>
        <td class="R8C2" colspan="7"><span style="white-space:nowrap;max-width:0px;">(марка,&nbsp;модель,&nbsp;тип,&nbsp;реєстраційний&nbsp;номер)</span></td>
        <td class="R8C2"><span></span></td>
        <td class="R8C2"><span></span></td>
        <td class="R8C2"><span></span></td>
        <td class="R8C2"><span></span></td>
        <td class="R8C2" colspan="5"><span style="white-space:nowrap;max-width:0px;">(марка,&nbsp;модель,&nbsp;тип,&nbsp;реєстраційний&nbsp;номер)</span></td>
        <td><span></span></td>
        <td><span></span></td>
        <td><span></span></td>
        <td><span></span></td>
...
<table style="width:100%; height:0px; " cellspacing="0">
    <colgroup><col width="18">
        ...
        <td><span></span></td>
        <td class="R9C1" colspan="4"><span style="white-space:nowrap;max-width:0px;">Автомобільний&nbsp;перевізник</span></td>
        <td class="R9C5"><span></span></td>
        <td class="R9C5" colspan="10"><?php echo $companyDoer["full_name_all"]?></td>
        <td class="R9C16"><span></span></td>
        <td class="R9C16">Водій</td>
...
<table style="width:100%; height:0px; " cellspacing="0">
    <colgroup><col width="18">
        ...
        <td class="R8C2" colspan="10"><span style="white-space:nowrap;max-width:0px;">(найменування&nbsp;/&nbsp;П.&nbsp;І.&nbsp;Б.)</span></td>
        <td><div style="position:relative; height:15px;width: 100%; overflow:hidden;"><span></span></div></td>
        <td><div style="position:relative; height:15px;width: 100%; overflow:hidden;"><span></span></div></td>
        <td class="R8C2" colspan="5"><span style="white-space:nowrap;max-width:0px;">(П.&nbsp;І.&nbsp;Б.,&nbsp;номер&nbsp;посвідчення&nbsp;водія)</span></td>
        <td><div style="position:relative; height:15px;width: 100%; overflow:hidden;"><span></span></div></td>
        <td><div style="position:relative; height:15px;width: 100%; overflow:hidden;"><span></span></div></td>
        <td><div style="width:100%;height:15px;overflow:hidden;"></div></td>
    </tr>
    <tr class="R5">
        <td><span></span></td>
        <td class="R9C1" colspan="3"><span style="white-space:nowrap;max-width:0px;">Замовник&nbsp;(платник)</span></td>
        <td class="R9C5" colspan="19"><?php echo $companyPayer["full_name_all"]?></td>
        <td><span></span></td>
        <td><span></span></td>
        <td></td>
    </tr>
    <tr class="R0">
        ...
        <td><span></span></td>
        <td><span></span></td>
        <td class="R8C2" colspan="19"><span style="white-space:nowrap;max-width:0px;">(найменування&nbsp;/&nbsp;П.&nbsp;І.&nbsp;Б.)</span></td>
        <td><span></span></td>
        <td><span></span></td>
        <td></td>
    </tr>
    ...
    <tr class="R7">
        <td><span></span></td>
        <td class="R14C1" colspan="3"><span style="white-space:nowrap;max-width:0px;">Вантажовідправник</span></td>
        <td class="R14C4" colspan="19"><?php echo $companySender["full_name_all"]?></td>
        <td><span></span></td>
        <td><span></span></td>
        <td></td>
    </tr>
    <tr class="R0">
        ...
        <td><span></span></td>
        <td><span></span></td>
        <td class="R8C2" colspan="19"><span style="white-space:nowrap;max-width:0px;">(повне&nbsp;найменування,&nbsp;місцезнаходження&nbsp;/&nbsp;П.&nbsp;І.&nbsp;Б.,&nbsp;місце&nbsp;проживання)</span></td>
        <td><span></span></td>
        <td><span></span></td>
        <td></td>
    </tr>
    ...
    <tr class="R5">
        <td><span></span></td>
        <td class="R9C1" colspan="3"><span style="white-space:nowrap;max-width:0px;">Вантажоодержувач</span></td>
        <td class="R9C5" colspan="19"><?php echo $companyReceiver["full_name_all"]?></td>
        <td><span></span></td>
        <td><span></span></td>
        <td></td>
    </tr>
    ...
    <tr class="R7">
        <td><span></span></td>
        <td class="R14C1" colspan="3"><span style="white-space:nowrap;max-width:0px;">Пункт&nbsp;навантаження</span></td>
        <td class="R7C13" colspan="9"><?php echo $uploadLocation["address"]?></td>
        <td class="R7C9" colspan="4">Пункт розвантаження</td>
        <td class="R7C13" colspan="6"><?php echo $downloadLocation["address"]?></td>
        <td><span></span></td>
        <td><span></span></td>
        <td></td>
    </tr>
    <tr class="R0">
        ...
        <td><span></span></td>
        <td><span></span></td>
        <td class="R8C2" colspan="9"><span style="white-space:nowrap;max-width:0px;">(місцезнаходження)</span></td>
        <td><span></span></td>
        <td><span></span></td>
        <td><span></span></td>
        <td><span></span></td>
        <td class="R8C2" colspan="6"><span style="white-space:nowrap;max-width:0px;">(місцезнаходження)</span></td>
        <td><span></span></td>
        <td><span></span></td>
        <td></td>
    </tr>
    <tr class="R21">
        <td><span></span></td>
        <td class="R21C1" colspan="4"><span style="white-space:nowrap;max-width:0px;">Переадресування&nbsp;вантажу</span></td>
    ...
    <tr class="R0">
        ...
        <td class="R8C2" colspan="17"><span style="white-space:nowrap;max-width:0px;">(найменування,&nbsp;місцезнаходження&nbsp;/&nbsp;П.&nbsp;І.&nbsp;Б.,&nbsp;місце&nbsp;проживання&nbsp;нового&nbsp;вантажоодержувача;&nbsp;П.&nbsp;І.&nbsp;Б.,&nbsp;посада&nbsp;та&nbsp;підпис&nbsp;відповідальної&nbsp;особи)</span></td>
        <td><span></span></td>
        <td><span></span></td>
        <td></td>
    </tr>
    <tr class="R21">
        <td><span></span></td>
        <td class="R21C1" colspan="7"><span style="white-space:nowrap;max-width:0px;">відпуск&nbsp;за&nbsp;довіреністю&nbsp;вантажоодержувача:&nbsp;серія</span></td>
        ...
        <td class="R23C9"><span style="white-space:nowrap;max-width:0px;">від</span></td>
        <td class="R23C10" colspan="3"><span></span></td>
        <td class="R23C16" colspan="2"><span style="white-space:nowrap;max-width:0px;">виданою</span></td>
    ...
    <tr class="R21">
        <td><span></span></td>
        <td class="R21C1" colspan="6"><span style="white-space:nowrap;max-width:0px;">Вантаж&nbsp;наданий&nbsp;для&nbsp;перевезення&nbsp;у&nbsp;стані,що&nbsp;</span></td>
        <td class="R25C7" colspan="3"><span style="white-space:nowrap;max-width:0px;">відповідає</span></td>
        <td class="R21C1" colspan="13"><span style="white-space:nowrap;max-width:0px;">правилам&nbsp;перевезень&nbsp;відповідних&nbsp;вантажів,&nbsp;номер&nbsp;пломби&nbsp;(за&nbsp;наявності)&nbsp;____________________________</span></td>
        <td class="R21C23" colspan="2"><span style="white-space:nowrap;max-width:0px;">,</span></td>
        <td></td>
    </tr>
    <tr class="R0">
        ...
        <td><span></span></td>
        <td><span></span></td>
        <td class="R8C2" colspan="3"><span style="white-space:nowrap;max-width:0px;">(відповідає&nbsp;/&nbsp;не&nbsp;відповідає)</span></td>
        <td class="R8C2"><span></span></td>
        <td class="R8C2"><span></span></td>
        <td><span></span></td>
        <td><span></span></td>
    ...
    <tr class="R28">
        <td><span></span></td>
        <td colspan="2"><span style="white-space:nowrap;max-width:0px;">кількість&nbsp;місць</span></td>
        <td class="R28C3" colspan="5"><span style="white-space:nowrap;max-width:0px;"><?php echo $requestConnected["cargo_amount"];?></span></td>
        <td class="R28C8" colspan="3"><span style="white-space:nowrap;max-width:0px;">,&nbsp;масою&nbsp;брутто,&nbsp;т</span></td>
        <td class="R28C11" colspan="3"><?php echo number_format($requestConnected["cargo_weight"]/1000,3,'.','');?></td>
        <td colspan="5"><span style="white-space:nowrap;max-width:0px;">,&nbsp;отримав&nbsp;водій/експедитор</span></td>
        <td class="R28C19" colspan="4"><span style="white-space:nowrap;max-width:0px;"><?php echo $driver["short_name"]?>,&nbsp;водій</span></td>
        <td><span></span></td>
        <td><span></span></td>
        <td></td>
    </tr>
    <tr class="R29">
        ...
        <td><div style="position:relative; height:12px;width: 100%; overflow:hidden;"><span></span></div></td>
        <td><div style="position:relative; height:12px;width: 100%; overflow:hidden;"><span></span></div></td>
        <td class="R29C3" colspan="5"><span style="white-space:nowrap;max-width:0px;">(словами)</span></td>
        <td><div style="position:relative; height:12px;width: 100%; overflow:hidden;"><span></span></div></td>
        <td><div style="position:relative; height:12px;width: 100%; overflow:hidden;"><span></span></div></td>
        <td><div style="position:relative; height:12px;width: 100%; overflow:hidden;"><span></span></div></td>
        <td class="R29C3" colspan="3"><span style="white-space:nowrap;max-width:0px;">(словами)</span></td>
        <td><div style="position:relative; height:12px;width: 100%; overflow:hidden;"><span></span></div></td>
        <td><div style="position:relative; height:12px;width: 100%; overflow:hidden;"><span></span></div></td>
        <td><div style="position:relative; height:12px;width: 100%; overflow:hidden;"><span></span></div></td>
        <td><div style="position:relative; height:12px;width: 100%; overflow:hidden;"><span></span></div></td>
        <td><div style="position:relative; height:12px;width: 100%; overflow:hidden;"><span></span></div></td>
        <td class="R29C3" colspan="4"><span style="white-space:nowrap;max-width:0px;">(П.&nbsp;І.&nbsp;Б.,&nbsp;посада,&nbsp;підпис)</span></td>
        <td><div style="position:relative; height:12px;width: 100%; overflow:hidden;"><span></span></div></td>
        <td><div style="position:relative; height:12px;width: 100%; overflow:hidden;"><span></span></div></td>
    ...
    <tr class="R30">
        <td><span></span></td>
        <td colspan="8"><span style="white-space:nowrap;max-width:0px;">Бухгалтер&nbsp;(відповідальна&nbsp;особа&nbsp;вантажовідправника)</span></td>
        <td class="R30C9" colspan="8"><?php echo $contact["surname"]." ".mb_substr($contact["name"],0,1)."."?></td>
        <td colspan="3"><span style="white-space:nowrap;max-width:0px;">Відпуск&nbsp;дозволив</span></td>
        <td class="R30C9" colspan="3"><?php echo $contact["surname"]." ".mb_substr($contact["name"],0,1)."."?></td>
        <td><span></span></td>
        <td><span></span></td>
        <td></td>
    </tr>
    <tr class="R30">
        ...
        <td><span></span></td>
        <td><span></span></td>
        <td class="R31C9" colspan="8"><span style="white-space:nowrap;max-width:0px;">(П.&nbsp;І.&nbsp;Б.,&nbsp;посада,&nbsp;підпис)</span></td>
        <td><span></span></td>
        <td><span></span></td>
        <td><span></span></td>
        <td class="R31C9" colspan="3"><span style="white-space:nowrap;max-width:0px;">(П.&nbsp;І.&nbsp;Б.,&nbsp;посада,&nbsp;підпис,&nbsp;печатка)</span></td>
        <td><span></span></td>
        <td><span></span></td>
        <td></td>
    </tr>
    <tr class="R30">
        <td><span></span></td>
        <td colspan="5"><span style="white-space:nowrap;max-width:0px;">Усього&nbsp;відпущено&nbsp;на&nbsp;загальну&nbsp;суму</span></td>
        <td class="R32C6" colspan="11"><span style="white-space:nowrap;max-width:0px;"><?php echo summToStr($requestConnected["cargo_price"]);?></span></td>
        <td colspan="2"><span style="white-space:nowrap;max-width:0px;">,&nbsp;у&nbsp;т.&nbsp;ч.&nbsp;ПДВ</span></td>
    ...
    <tr class="R30">
        ...
        <td><span></span></td>
        <td><span></span></td>
        <td class="R31C9" colspan="11"><span style="white-space:nowrap;max-width:0px;">(словами,&nbsp;з&nbsp;урахуванням&nbsp;ПДВ)</span></td>
        <td><span></span></td>
        <td><span></span></td>
        <td><span></span></td>
        <td><span></span></td>
    ...
    <tr class="R30">
        <td><span></span></td>
        <td colspan="5"><span style="white-space:nowrap;max-width:0px;">Супровідні&nbsp;документи&nbsp;на&nbsp;вантаж</span></td>
    ...
    <tr class="R30">
        <td><span></span></td>
        <td colspan="10"><span style="white-space:nowrap;max-width:0px;">Транспортні&nbsp;послуги,&nbsp;які&nbsp;надаються&nbsp;автомобільним&nbsp;перевізником:</span></td>
        <td class="R37C11" colspan="12"><span style="white-space:nowrap;max-width:0px;">Автоперевезення</span></td>
        <td><span></span></td>
        <td><span></span></td>
        <td></td>
    </tr>
...
<table style="width:100%; height:0px; " cellspacing="0">
    <colgroup><col width="7">
        ...
        <td class="R39C1" colspan="10"><span style="white-space:nowrap;max-width:0px;">ВІДОМОСТІ&nbsp;ПРО&nbsp;ВАНТАЖ</span></td>
        <td><div style="position:relative; height:20px;width: 100%; overflow:hidden;"><span></span></div></td>
...
<table style="width:100%; height:0px; " cellspacing="0">
    <colgroup><col width="18">
        ...
        <td><span></span></td>
        <td class="R40C1">№ з/п</td>
        <td class="R40C1">Найменування вантажу (номер контейнера), у разі перевезення небезпечних вантажів: клас небезпечних речовин, до якого віднесено вантаж</td>
        <td class="R40C1">Один. виміру</td>
        <td class="R40C1">Кількість місць</td>
        <td class="R40C1">Ціна без ПДВ за одиницю, грн</td>
        <td class="R40C1">Загальна сума з ПДВ, грн</td>
        <td class="R40C1">Вид пакування</td>
        <td class="R40C1">Документи з вантажем</td>
        <td class="R40C1">Маса брутто, т</td>
        <td><span></span></td>
        <td></td>
    </tr>
    <tr class="R41">
    ...
    <tr class="R42">
        <td><span></span></td>
        <td class="R42C1">1</td>
        <td class="R42C2">В.Н. № <?php echo $requestConnected["intronumber"]." від ".date("d.m.Y",$requestConnected["created"])?></td>
        <td class="R42C3"><span style="white-space:nowrap;max-width:0px;">пал</span></td>
        <td class="R42C4"><span style="white-space:nowrap;max-width:0px;"><?php echo $requestConnected["cargo_amount"];?></span></td>
        <td class="R42C4"><span></span></td>
        <td class="R42C4"><span></span></td>
        <td class="R42C3"><span style="white-space:nowrap;max-width:0px;">пал</span></td>
        <td class="R42C8"><span></span></td>
        <td class="R42C9"><span style="white-space:nowrap;max-width:0px;"><?php echo number_format($requestConnected["cargo_weight"]/1000,3,'.','');?></span></td>
        <td><span></span></td>
        <td></td>
    </tr>
    <tr class="R43">
        <td class="R43C0"><span></span></td>
        <td class="R43C1" colspan="2"><span style="white-space:nowrap;max-width:0px;">Всього:</span></td>
        <td class="R43C3"><span></span></td>
        <td class="R43C3"><span style="white-space:nowrap;max-width:0px;"><?php echo $requestConnected["cargo_amount"];?></span></td>
        <td class="R43C5"><span></span></td>
        <td class="R43C6"><span></span></td>
        <td class="R43C6"><span></span></td>
        <td class="R43C6"><span></span></td>
        <td class="R43C6"><span style="white-space:nowrap;max-width:0px;"><?php echo number_format($requestConnected["cargo_weight"]/1000,3,'.','');?></span></td>
        <td><span></span></td>
        <td></td>
    </tr>
    </tbody></table>
<table style="width:100%; height:0px; " cellspacing="0">
    <colgroup><col width="24">
        ...
        <td><span></span></td>
        <td class="R44C1" colspan="4">Здав (відповідальна особа вантажовідправника)</td>
        <td class="R44C5"><span></span></td>
        <td class="R44C5" colspan="4"><span style="white-space:nowrap;max-width:0px;">Прийняв&nbsp;водій/експедитор</span></td>
        <td class="R44C5"><span></span></td>
        <td class="R44C5" colspan="4"><span style="white-space:nowrap;max-width:0px;">Здав&nbsp;водій/експедитор</span></td>
        <td class="R44C5"><span></span></td>
        <td class="R44C1" colspan="4">Прийняв (відповідальна особа вантажоодержувача)</td>
        <td><span></span></td>
        <td></td>
    </tr>
    <tr class="R43">
        <td><span></span></td>
        <td class="R45C1" colspan="4"><?php echo $contact["surname"]." ".mb_substr($contact["name"],0,1)."."?></td>
        <td><span></span></td>
        <td class="R45C6" colspan="4"><span style="white-space:nowrap;max-width:0px;"><?php echo $driver["surname"]." ".mb_substr($driver["name"],0,1)."."?>,&nbsp;водій</span></td>
        <td><span></span></td>
        <td class="R45C6" colspan="4"><span style="white-space:nowrap;max-width:0px;"><?php echo $driver["surname"]." ".mb_substr($driver["name"],0,1)."."?>,&nbsp;водій</span></td>
        <td><span></span></td>
    ...
    <tr class="R30">
        ...
        <td class="R31C9" colspan="4"><span style="white-space:nowrap;max-width:0px;">(П.&nbsp;І.&nbsp;Б.,&nbsp;посада,&nbsp;підпис,&nbsp;печатка)</span></td>
        <td><div style="position:relative; height:16px;width: 100%; overflow:hidden;"><span></span></div></td>
        <td class="R31C9" colspan="4"><span style="white-space:nowrap;max-width:0px;">(П.&nbsp;І.&nbsp;Б.,&nbsp;посада,&nbsp;підпис)</span></td>
        <td><div style="position:relative; height:16px;width: 100%; overflow:hidden;"><span></span></div></td>
        <td class="R31C9" colspan="4"><span style="white-space:nowrap;max-width:0px;">(П.&nbsp;І.&nbsp;Б.,&nbsp;посада,&nbsp;підпис)</span></td>
        <td><div style="position:relative; height:16px;width: 100%; overflow:hidden;"><span></span></div></td>
        <td class="R31C9" colspan="4"><span style="white-space:nowrap;max-width:0px;">(П.&nbsp;І.&nbsp;Б.,&nbsp;посада,&nbsp;підпис,&nbsp;печатка)</span></td>
...
<table style="width:100%; height:0px; " cellspacing="0">
    <colgroup><col width="17">
        ...
        <td><span></span></td>
        <td class="R47C1" colspan="6"><span style="white-space:nowrap;max-width:0px;">ВАНТАЖНО-РОЗВАНТАЖУВАЛЬНІ&nbsp;ОПЕРАЦІЇ</span></td>
        <td><span></span></td>
        <td></td>
    </tr>
    <tr class="R0">
        <td><span></span></td>
        <td class="R48C1" rowspan="3">Операція</td>
        <td class="R48C2" rowspan="3">Маса брутто, т</td>
        <td class="R48C3" colspan="3"><span style="white-space:nowrap;max-width:0px;">Час&nbsp;(год.,&nbsp;хв.)</span></td>
        <td class="R48C6" rowspan="3">Підпис відповідальної особи</td>
        <td><span></span></td>
        <td></td>
    </tr>
    <tr class="R0">
        <td rowspan="2"><span></span></td>
        <td class="R48C1" rowspan="2">прибуття</td>
        <td class="R48C3" rowspan="2"><span style="white-space:nowrap;max-width:0px;">вибуття</span></td>
        <td class="R49C5" rowspan="2"><span style="white-space:nowrap;max-width:0px;">простою</span></td>
        <td><span></span></td>
        <td></td>
    </tr>
    <tr class="R0">
    ...
    <tr class="R0">
        <td><span></span></td>
        <td class="R52C1"><span style="white-space:nowrap;max-width:0px;">Навантаження</span></td>
        <td class="R52C2"><span style="white-space:nowrap;max-width:0px;"><?php echo number_format($requestConnected["cargo_weight"]/1000,3,'.','');?></span></td>
    ...
    <tr class="R0">
        <td><span></span></td>
        <td class="R52C1"><span style="white-space:nowrap;max-width:0px;">Розвантаження</span></td>
        <td class="R52C2"><span style="white-space:nowrap;max-width:0px;"><?php echo number_format($requestConnected["cargo_weight"]/1000,3,'.','');?></span></td>
        <td class="R52C1"><span></span></td>
