            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">Перегляд запитів</h4> <a class="btn btn-success waves-effect waves-float waves-light disabled" href="create.php">Створити <i data-feather='plus'></i></a>
                    </div>
                    <div class="card-body">
                        <p class="card-text">
                            Перегляд складських запитів на відвантаження продукції
                        </p>
                    </div>
