...
if(isset($_POST["number"])) {
    ...
    curl_setopt_array($curl, array(
        ...
        CURLOPT_POST => true,
        CURLOPT_POSTFIELDS => json_encode(array("source" => "https://$_SERVER[HTTP_HOST]/desktop/requests/to_send/include/print_pallet_content.php?id=".$_POST["id"], "landscape" => false, "use_print" => false, "margin"=>"0px 5px 0px 10px")),
