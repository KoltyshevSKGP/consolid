...
switch ($request["status"]) {
    ...
    case 3://затверджено
        if(
            ...
            echo '<a href="edit.php?id='.$_GET["id"].'" style="width: 100%" class="btn btn-warning btn-sm waves-effect waves-float waves-light">Редагувати <i data-feather="edit"></i></a><br><br>';
            echo '<a href="/desktop/requests/ttn/create.php?request_connected='.$_GET["id"].'" style="width: 100%" class="btn btn-success btn-sm waves-effect waves-float waves-light">Створити рейс <i data-feather="check"></i></a><br><br>';
        }
        break;
}
echo '<a href="print_pallet.php?id='.$_GET["id"].'" target="_blank" style="width: 100%" class=" btn btn-success btn-sm waves-effect waves-float waves-light">Палетні листи <i data-feather="printer"></i></a><br><br>';
?>
</p>
