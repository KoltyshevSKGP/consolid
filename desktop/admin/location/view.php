                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <p class="card-text">
                            ...
                            <a href="edit.php?id=<?php echo $_GET["id"]?>" style="width: 100%" class="btn btn-warning btn-sm waves-effect waves-float waves-light <?php if($_SESSION["role"]!=1 && $_SESSION["company_id"]!=$location["company"]) echo "disabled";?>">Редагувати <i data-feather='edit'></i></a><br><br>
                        </p>
                    </div>
                </div>
            </div>
