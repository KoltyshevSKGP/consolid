        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">Редагування автомобіля</h4>
                </div>
                <div class="card-body">
                    <div class="row">
                    ...
                    <a href="view.php" style="width: 100%" class="btn btn-success btn-sm waves-effect waves-float waves-light">Зберегти</a><br><br>
                </div>
            </div>
        </div>
    </div>
