...
<head>
    ...
    <title>Login Page - SK WMS Pro</title>
            ...
            <div class="auth-wrapper auth-v2">
                <div class="auth-inner row m-0">
                    ...
                    <div class="d-none d-lg-flex col-lg-8 align-items-center p-5">
                        <div class="w-100 d-lg-flex align-items-center justify-content-center px-5"><img class="img-fluid" src="/source/app-assets/images/pages/login-v2.svg" alt="Login V2" /></div>
                    </div>
                    <!-- /Left Text-->
                    <!-- Login-->
                    <div class="d-flex col-lg-4 align-items-center auth-bg px-2 p-lg-5">
                        <div class="col-12 col-sm-8 col-md-6 col-lg-12 px-xl-2 mx-auto">
                            <h2 class="card-title fw-bold mb-1">Welcome to SK WMS Pro! 👋</h2>
                            ...
                            <p class="text-center mt-2"><span>Need an access?</span><a href="page-auth-register-v2.html"><span>&nbsp;Mail to admin</span></a></p>
                            <div class="divider my-2">
                                <div class="divider-text">SK WMS Pro V3.001</div>
                            </div>
                        </div>
                    </div>
                    <!-- /Login-->
