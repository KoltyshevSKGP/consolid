...
curl_setopt_array($curl, array(
    ...
    CURLOPT_POST => true,
    CURLOPT_POSTFIELDS => json_encode(array("source" => "https://$_SERVER[HTTP_HOST]/test/execution/pallet/index.html", "landscape" => true, "use_print" => false, "margin"=>"0px 5px 0px 10px")),
